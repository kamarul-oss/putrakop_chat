...
/**
 * Form request for Manager FAQ update.
 *
 * SECURITY: Managers can only update entries within their own department.
 */
final class ManagerUpdateFAQRequest extends FormRequest
{
